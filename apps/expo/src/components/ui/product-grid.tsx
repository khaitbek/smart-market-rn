...
export function ProductCard({ product, className }: ProductCardProps) {
  ...
  // const previous = index === 0 ? product : products[index - 1];
  // const smallestTitleLength = (
  //   previous!.name.length > product.name.length
  //     ? previous?.name?.length
  //     : product.name.length
  // )!;
  // const lineClamp = useMemo(() => {
  //   return Math.floor(smallestTitleLength / 10);
  // }, [smallestTitleLength]);
